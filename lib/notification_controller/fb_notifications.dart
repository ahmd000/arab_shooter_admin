...
mixin FbNotifications {
  ...
  String serverToken =
      "AAAAs67CLf8:APA91bGiAy-VeD8fpFU8AsNp40TU8t0B3PfcGis72L9f-lYluUUXbJsnlaocwjDVq0wp6PMYmBojjB7jSHB4eDrAD2F0TFQcuSjFPmGclqogexaur7dYHcjtSmc8cmpDgL6ShEpY3Ztd";
  ...
  //GENERAL (Android & iOS)
  void manageNotificationTerminated() async {
  ...
  void manageNotificationBackGround() {
  ...
  subscribeGeneralTopic() async {
    ...
    print("subscribe To Topic $generalTopic");
  }
  ...
  sendGeneralNotify(
    String title,
    String body,
    String imageCloseUpDownloadURL,
  ) async {
